...
public class VLC_Player : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        // Play On Start
        pinMapName = EventManager.Instance.pinMapName;
        Open(EventManager.Instance.cctvURL);
    ...
    private void close()
    {
        ...
        EventManager.Instance.ResponsePanelDestruction(pinMapName, cctvURL);
        Destroy(gameObject);
    }
    ...
    #region vlc
    public void Open(string cctvURL)
    {
        Log("VLCPlayerExample Open " + cctvURL);
